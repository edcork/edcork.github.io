...
### Writing: [OMT Installation](/pages/write/install_landing.html)

These pages taken from a product's installation section showcase writing for multiple audiences. The section's [landing page](/pages/write/install_landing.html) and [main flow of topics](/pages/write/install_prereq_tasks.html) contain sufficient information for expert Kubernetes admins to install the product. Each task in these pages links to [a detailed "how-to" topic](/pages/write/create_sudouser.html) that walks admins new to Kubernetes through the steps to configure their environment.

### Editing:  [Integration guide](/pages/edit/edit3.html)

This topic showcases restructuring content for improved clarity.

### Design: [Online help restructure](/pages/design/help_restructure.html)
