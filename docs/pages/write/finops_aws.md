...
4.  Go to to **Administration** \> **Master Data** \> **People** \> **Roles**, and create a role (with the Application value **SMAX**) with the **Create**, **View**, and **Update** permissions for the **Cloud Account** record type.
5.  Go to to **Administration** \> **Master Data** \> **People**, locate the integration user, and then assign the created role to the user.
